...
```powershell
# Windows PowerShell
Invoke-WebRequest https://github.com/enfein/mieru/releases/download/v1.6.1/mieru_1.6.1_windows_amd64.zip -OutFile mieru_1.6.1_windows_amd64.zip
```

```sh
# Mac OS (Intel CPU)
curl -LSO https://github.com/enfein/mieru/releases/download/v1.6.1/mieru_1.6.1_darwin_amd64.tar.gz

# Mac OS (ARM CPU)
curl -LSO https://github.com/enfein/mieru/releases/download/v1.6.1/mieru_1.6.1_darwin_arm64.tar.gz
```
...
```sh
# Debian / Ubuntu
curl -LSO https://github.com/enfein/mieru/releases/download/v1.6.1/mieru_1.6.1_amd64.deb
sudo dpkg -i mieru_1.6.1_amd64.deb

# Fedora / CentOS / Red Hat Enterprise Linux
curl -LSO https://github.com/enfein/mieru/releases/download/v1.6.1/mieru-1.6.1-1.x86_64.rpm
sudo rpm -Uvh --force mieru-1.6.1-1.x86_64.rpm

# Others
curl -LSO https://github.com/enfein/mieru/releases/download/v1.6.1/mieru_1.6.1_linux_amd64.tar.gz
tar -zxvf mieru_1.6.1_linux_amd64.tar.gz
```
