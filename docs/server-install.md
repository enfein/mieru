...
curl -LSO https://github.com/enfein/mieru/releases/download/v1.14.1/mita_1.14.1_arm64.deb

# Fedora / CentOS / Red Hat Enterprise Linux - X86_64
curl -LSO https://github.com/enfein/mieru/releases/download/v1.14.1/mita-1.14.1-1.x86_64.rpm

# Fedora / CentOS / Red Hat Enterprise Linux - ARM 64
curl -LSO https://github.com/enfein/mieru/releases/download/v1.14.1/mita-1.14.1-1.aarch64.rpm
```
...
# Debian / Ubuntu - ARM 64
sudo dpkg -i mita_1.14.1_arm64.deb

# Fedora / CentOS / Red Hat Enterprise Linux - X86_64
sudo rpm -Uvh --force mita-1.14.1-1.x86_64.rpm

# Fedora / CentOS / Red Hat Enterprise Linux - ARM 64
sudo rpm -Uvh --force mita-1.14.1-1.aarch64.rpm
```
