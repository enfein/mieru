...
curl -LSO https://github.com/enfein/mieru/releases/download/v3.33.0/mita_3.33.0_amd64.deb

# Debian / Ubuntu - ARM 64
curl -LSO https://github.com/enfein/mieru/releases/download/v3.33.0/mita_3.33.0_arm64.deb

# RedHat / CentOS / Rocky Linux - X86_64
curl -LSO https://github.com/enfein/mieru/releases/download/v3.33.0/mita-3.33.0-1.x86_64.rpm

# RedHat / CentOS / Rocky Linux - ARM 64
curl -LSO https://github.com/enfein/mieru/releases/download/v3.33.0/mita-3.33.0-1.aarch64.rpm
```
...
```sh
# Debian / Ubuntu - X86_64
sudo dpkg -i mita_3.33.0_amd64.deb

# Debian / Ubuntu - ARM 64
sudo dpkg -i mita_3.33.0_arm64.deb

# RedHat / CentOS / Rocky Linux - X86_64
sudo rpm -Uvh --force mita-3.33.0-1.x86_64.rpm

# RedHat / CentOS / Rocky Linux - ARM 64
sudo rpm -Uvh --force mita-3.33.0-1.aarch64.rpm
```
