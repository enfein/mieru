...
```sh
# Debian / Ubuntu
curl -LSO https://github.com/enfein/mieru/releases/download/v1.6.0/mita_1.6.0_amd64.deb

# Fedora / CentOS / Red Hat Enterprise Linux
curl -LSO https://github.com/enfein/mieru/releases/download/v1.6.0/mita-1.6.0-1.x86_64.rpm
```
...
```sh
# Debian / Ubuntu
sudo dpkg -i mita_1.6.0_amd64.deb

# Fedora / CentOS / Red Hat Enterprise Linux
sudo rpm -Uvh --force mita-1.6.0-1.x86_64.rpm
```
