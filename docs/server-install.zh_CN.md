...
curl -LSO https://github.com/enfein/mieru/releases/download/v2.3.0/mita_2.3.0_amd64.deb

# Debian / Ubuntu - ARM 64
curl -LSO https://github.com/enfein/mieru/releases/download/v2.3.0/mita_2.3.0_arm64.deb

# Fedora / CentOS / RedHat - X86_64
curl -LSO https://github.com/enfein/mieru/releases/download/v2.3.0/mita-2.3.0-1.x86_64.rpm

# Fedora / CentOS / RedHat - ARM 64
curl -LSO https://github.com/enfein/mieru/releases/download/v2.3.0/mita-2.3.0-1.aarch64.rpm
```
...
```sh
# Debian / Ubuntu - X86_64
sudo dpkg -i mita_2.3.0_amd64.deb

# Debian / Ubuntu - ARM 64
sudo dpkg -i mita_2.3.0_arm64.deb

# Fedora / CentOS / RedHat - X86_64
sudo rpm -Uvh --force mita-2.3.0-1.x86_64.rpm

# Fedora / CentOS / RedHat - ARM 64
sudo rpm -Uvh --force mita-2.3.0-1.aarch64.rpm
```
