...
var file_lifecycle_proto_rawDesc = []byte{
	...
	0x53, 0x54, 0x4f, 0x50, 0x50, 0x49, 0x4e, 0x47, 0x10, 0x04, 0x32, 0xf7, 0x02, 0x0a, 0x16, 0x43,
	...
	0x63, 0x74, 0x6c, 0x2e, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x12, 0x32, 0x0a, 0x0d, 0x47,
	...
	0x6d, 0x70, 0x74, 0x79, 0x32, 0xc4, 0x03, 0x0a, 0x16, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x4c,
	...
	0x63, 0x73, 0x12, 0x32, 0x0a, 0x0d, 0x47, 0x65, 0x74, 0x54, 0x68, 0x72, 0x65, 0x61, 0x64, 0x44,
	0x75, 0x6d, 0x70, 0x12, 0x0d, 0x2e, 0x61, 0x70, 0x70, 0x63, 0x74, 0x6c, 0x2e, 0x45, 0x6d, 0x70,
	0x74, 0x79, 0x1a, 0x12, 0x2e, 0x61, 0x70, 0x70, 0x63, 0x74, 0x6c, 0x2e, 0x54, 0x68, 0x72, 0x65,
	0x61, 0x64, 0x44, 0x75, 0x6d, 0x70, 0x12, 0x39, 0x0a, 0x0f, 0x53, 0x74, 0x61, 0x72, 0x74, 0x43,
	0x50, 0x55, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x12, 0x17, 0x2e, 0x61, 0x70, 0x70, 0x63,
	...
	0x79, 0x12, 0x2e, 0x0a, 0x0e, 0x53, 0x74, 0x6f, 0x70, 0x43, 0x50, 0x55, 0x50, 0x72, 0x6f, 0x66,
	0x69, 0x6c, 0x65, 0x12, 0x0d, 0x2e, 0x61, 0x70, 0x70, 0x63, 0x74, 0x6c, 0x2e, 0x45, 0x6d, 0x70,
	0x74, 0x79, 0x1a, 0x0d, 0x2e, 0x61, 0x70, 0x70, 0x63, 0x74, 0x6c, 0x2e, 0x45, 0x6d, 0x70, 0x74,
	0x79, 0x12, 0x38, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x48, 0x65, 0x61, 0x70, 0x50, 0x72, 0x6f, 0x66,
	0x69, 0x6c, 0x65, 0x12, 0x17, 0x2e, 0x61, 0x70, 0x70, 0x63, 0x74, 0x6c, 0x2e, 0x50, 0x72, 0x6f,
	0x66, 0x69, 0x6c, 0x65, 0x53, 0x61, 0x76, 0x65, 0x50, 0x61, 0x74, 0x68, 0x1a, 0x0d, 0x2e, 0x61,
	0x70, 0x70, 0x63, 0x74, 0x6c, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x42, 0x2d, 0x5a, 0x2b, 0x67,
...
var file_lifecycle_proto_goTypes = []interface{}{
	...
	(*ThreadDump)(nil),      // 5: appctl.ThreadDump
}
var file_lifecycle_proto_depIdxs = []int32{
	...
	2,  // 4: appctl.ClientLifecycleService.GetThreadDump:input_type -> appctl.Empty
	3,  // 5: appctl.ClientLifecycleService.StartCPUProfile:input_type -> appctl.ProfileSavePath
	2,  // 6: appctl.ClientLifecycleService.StopCPUProfile:input_type -> appctl.Empty
	3,  // 7: appctl.ClientLifecycleService.GetHeapProfile:input_type -> appctl.ProfileSavePath
	2,  // 8: appctl.ServerLifecycleService.GetStatus:input_type -> appctl.Empty
	2,  // 9: appctl.ServerLifecycleService.Start:input_type -> appctl.Empty
	2,  // 10: appctl.ServerLifecycleService.Stop:input_type -> appctl.Empty
	2,  // 11: appctl.ServerLifecycleService.Exit:input_type -> appctl.Empty
	2,  // 12: appctl.ServerLifecycleService.GetMetrics:input_type -> appctl.Empty
	2,  // 13: appctl.ServerLifecycleService.GetThreadDump:input_type -> appctl.Empty
	3,  // 14: appctl.ServerLifecycleService.StartCPUProfile:input_type -> appctl.ProfileSavePath
	2,  // 15: appctl.ServerLifecycleService.StopCPUProfile:input_type -> appctl.Empty
	3,  // 16: appctl.ServerLifecycleService.GetHeapProfile:input_type -> appctl.ProfileSavePath
	1,  // 17: appctl.ClientLifecycleService.GetStatus:output_type -> appctl.AppStatusMsg
	2,  // 18: appctl.ClientLifecycleService.Exit:output_type -> appctl.Empty
	4,  // 19: appctl.ClientLifecycleService.GetMetrics:output_type -> appctl.Metrics
	5,  // 20: appctl.ClientLifecycleService.GetThreadDump:output_type -> appctl.ThreadDump
	2,  // 21: appctl.ClientLifecycleService.StartCPUProfile:output_type -> appctl.Empty
	2,  // 22: appctl.ClientLifecycleService.StopCPUProfile:output_type -> appctl.Empty
	2,  // 23: appctl.ClientLifecycleService.GetHeapProfile:output_type -> appctl.Empty
	1,  // 24: appctl.ServerLifecycleService.GetStatus:output_type -> appctl.AppStatusMsg
	2,  // 25: appctl.ServerLifecycleService.Start:output_type -> appctl.Empty
	2,  // 26: appctl.ServerLifecycleService.Stop:output_type -> appctl.Empty
	2,  // 27: appctl.ServerLifecycleService.Exit:output_type -> appctl.Empty
	4,  // 28: appctl.ServerLifecycleService.GetMetrics:output_type -> appctl.Metrics
	5,  // 29: appctl.ServerLifecycleService.GetThreadDump:output_type -> appctl.ThreadDump
	2,  // 30: appctl.ServerLifecycleService.StartCPUProfile:output_type -> appctl.Empty
	2,  // 31: appctl.ServerLifecycleService.StopCPUProfile:output_type -> appctl.Empty
	2,  // 32: appctl.ServerLifecycleService.GetHeapProfile:output_type -> appctl.Empty
